...
> **MaaFramework** 是基于图像识别技术的新一代自动化测试框架，源自 [MAA](https://github.com/MaaAssistantArknights/MaaAssistantArknights) 的开发经验，具有低代码、高扩展性的特点。
...
启动后不要急着执行任务，先浏览一下界面，了解有哪些功能和设置项。**界面中没有显示的功能，说明尚未实现，请勿尝试使用。**

### 2. 设置快捷键（推荐）

进入 **右上角「设置」→「快捷键」**，开启全局快捷键。建议将 `F11` 设置为快速结束任务的快捷键，以防程序卡死时无法退出。
